...
class SanityMailTest(BaseTest):
    ...
    def test_mail_sync(self):
        ...
        time.sleep(4)
        file_created = slash.g.sunriver.linux.ui.dogtail.procedural.os.path.exists(file_to_send)
        ...
        time.sleep(12)
        slash.g.sunriver.linux.ui.dogtail.rawinput.keyCombo('<Ctrl>s')
        time.sleep(5)
        slash.g.sunriver.linux.ui.dogtail.rawinput.keyCombo('<Ctrl>w')
        time.sleep(2)
        slash.g.sunriver.vnc.OpenVnc()
        log.info("Opening phone mail app")
